...
namespace Offsets
{
	constexpr int32 GObjects          = 0x8884A00;
	constexpr int32 AppendString      = 0x2D5B6A0;
	constexpr int32 GNames            = 0x2D55B04;
	constexpr int32 GWorld            = 0x89F2718;
	constexpr int32 ProcessEvent      = 0x2EDE120;
