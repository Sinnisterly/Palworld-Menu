...
{
public:
	uint8                                         Pad_245C[0x68];                                    // 0x04A0(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_245D[0x3];                                     // 0x07C1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_245E[0xC];                                     // 0x07D4(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2460[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2461[0x4];                                     // 0x007C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2462[0x68];                                    // 0x0028(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2463[0x8];                                     // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2464[0x198];                                   // 0x0048(0x0198)(Fixing Struct Size After Last Property [ Dumper-7 ])
